...
class CurrencyService {
  ...
  Future<CurrencyInfo> getCurrencyInfo(String symbol) async {
    final String url =
        'https://query2.finance.yahoo.com/v10/finance/quoteSummary/$symbol=X?modules=price,summaryDetail';
    try {
  ...
  Future<List<Indicator>> getCurrencyChart(String symbol) async {
    final String fromDate = '1626307200';
    DateTime date = DateTime.now();
    var now = date.toUtc().millisecondsSinceEpoch;
    final String url =
        'https://query1.finance.yahoo.com/v8/finance/chart/$symbol=X?symbol=$symbol=X&period1=$fromDate&period2=$now&interval=1d';
